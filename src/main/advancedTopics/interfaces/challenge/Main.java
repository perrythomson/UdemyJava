...
public class Main {
    public static void main(String[] args) {
        ...
        saveObject(tim);
//        loadObject(tim);  //if this loads, nothing beyond here will print
        System.out.println(tim);

//        Monster wereWolf = new Monster("Werewolf", 20, 100);  //same as 2 lines below
//        wereWolf.getStrength();
        ISaveable wereWolf = new Monster("Werewolf", 20, 100);
        //declared it as an interface but want to get access to specific methods in the class ...use this to cast
